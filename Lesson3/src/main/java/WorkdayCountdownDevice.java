...
// табло отображает «28800» (т.е. остаётся 8 часов),
// когда времени 14:30 — на табло «9000» (т.е. остаётся два с половиной часа), а когда наступает 17 часов
// — на табло отображается «0»
...
// Иванов вызвался помочь сотрудницам и написать программу, которая вместо секунд будет выводить на табло
// понятные фразы с информацией о том,
...
public class WorkdayCountdownDevice {
    public static void main(String[] args) {
        Random random = new Random();
        int secondsRemaining = random.nextInt(28801);
        displayHourCount(secondsRemaining);
    }

    private static void displayHourCount(int seconds) {
        ...
        System.out.println("Осталось " + hours + " " + result);
    }
}
